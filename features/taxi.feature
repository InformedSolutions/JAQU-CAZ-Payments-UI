Feature: Taxidiscountcaz Taxi
  ...
  Scenario: User wants to pay for a taxi which has incomplete DVLA data
    ...
    Then I should be on the daily charge page
      And I should see 'If your vehicle does meet emission standards, you can claim a refund from the local authority after your registration details have been updated.'
